...
function addIngredient(ingredientCategory) {
    ...
    ingredientList.innerHTML += "<input type='hidden' name='ingredientId_" + ingredientCounter + "' value='" + newIngredient + "' /><p class='text-white' id='ingredientId_" + ingredientCounter + "'>" + newIngredient + "<button type=\"button\" class=\"minusButton buttonShadow\" onclick=\"removeIngredient('ingredientId_" + ingredientCounter + "')\">-</button></p>";
    ingredientCounter++;
}
